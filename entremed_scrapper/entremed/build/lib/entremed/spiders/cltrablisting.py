...
from entremed.items import RawJobItem
...
#   At the creation of the spider, we request JWT for every API with
#   which we interact.
    def __init__(self):
        self.raw_jobs_jwt = self.get_jwt('rawjobs')
        self.watchdog_jwt = self.get_jwt('watchdog')
        self.jobpostings = []
        self.nextscrappings = []
...
#   The urls to fetch are saved in a list. 
        self.start_urls = [
            "https://www.chiletrabajos.cl/encuentra-un-empleo?2\
            =enfermera&13=&fecha=3&categoria=&8=&14=&inclusion=&f=2"
            # "https://www.chiletrabajos.cl/encuentra-un-empleo?2\
            # =enfermeria&13=&fecha=3&categoria=&8=&14=&inclusion=&f=2",
            # "https://www.chiletrabajos.cl/encuentra-un-empleo?2\
            # =tens&13=&fecha=3&categoria=&8=&14=&inclusion=&f=2",
            # "https://www.chiletrabajos.cl/encuentra-un-empleo?2\
            # =tecnico+en+enfermeria&13=&fecha=3&categoria=&8=&14=&inclusion=&f=2",
            # "https://www.chiletrabajos.cl/encuentra-un-empleo?2\
            # =psicologo&13=&fecha=3&categoria=&8=&14=&inclusion=&f=2",
            # "https://www.chiletrabajos.cl/encuentra-un-empleo?2\
            # =psicologia&13=&fecha=3&categoria=&8=&14=&inclusion=&f=2",
            # "https://www.chiletrabajos.cl/encuentra-un-empleo?2\
            # =odontologo&13=&fecha=3&categoria=&8=&14=&inclusion=&f=2",
            # "https://www.chiletrabajos.cl/encuentra-un-empleo?2\
            # =odontologia&13=&fecha=3&categoria=&8=&14=&inclusion=&f=2",
            # "https://www.chiletrabajos.cl/encuentra-un-empleo?2\
            # =kinesiologo&13=&fecha=3&categoria=&8=&14=&inclusion=&f=2",
            # "https://www.chiletrabajos.cl/encuentra-un-empleo?2\
            # =kinesiologia&13=&fecha=3&categoria=&8=&14=&inclusion=&f=2",
            # "https://www.chiletrabajos.cl/encuentra-un-empleo?2\
            # =psicopedagogo&13=&fecha=3&categoria=&8=&14=&inclusion=&f=2",
            # "https://www.chiletrabajos.cl/encuentra-un-empleo?2\
            # =psicopedagogia&13=&fecha=3&categoria=&8=&14=&inclusion=&f=2",
            # "https://www.chiletrabajos.cl/encuentra-un-empleo?2\
            # =fonoaudiologo&13=&fecha=3&categoria=&8=&14=&inclusion=&f=2",
            # "https://www.chiletrabajos.cl/encuentra-un-empleo?2\
            # =fonoaudiologia&13=&fecha=3&categoria=&8=&14=&inclusion=&f=2",
            # "https://www.chiletrabajos.cl/encuentra-un-empleo?2\
            # =nutricionista&13=&fecha=3&categoria=&8=&14=&inclusion=&f=2",
            # "https://www.chiletrabajos.cl/encuentra-un-empleo?2\
            # =paramedico&13=&fecha=3&categoria=&8=&14=&inclusion=&f=2"
        ]
...
#   we use original url.
        for url in self.start_urls:
            if settings.PROXY_CHILETRABAJO == "ON":
                source_url = url
...
#       We search for the root selector to work with
        ...
        for job_offer in root: 
            item = ItemLoader(item=RawJobItem(), selector=job_offer)
