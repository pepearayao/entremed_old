...
dict_to_secret = {
    ...
    'watchdog_db_name': 'user_' + str(b64encode(token_bytes(8)).decode()),
    'watchdog_db_username': 'watchdog',
    ...
    'scrapper_api_username':  'scraper_' + str(b64encode(token_bytes(8)).decode()),
    'scrapper_api_password':  b64encode(token_bytes(64)).decode(),
